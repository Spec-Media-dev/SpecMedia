    ...
    if client_reviews:
        ...
        for rev in reviews_pool:
            ...
            if current_lang == 'ar':
                ...
                ig_cards.append(
                    f'<article data-rv="1" class="ig-card" style="flex:none;width:clamp(310px,26vw,380px);border-radius:18px;overflow:hidden;display:flex;flex-direction:column;direction:rtl;text-align:right;font-family:\'Cairo\',sans-serif;will-change:transform">'
                    f'<div style="display:flex;align-items:center;justify-content:space-between;padding:12px 14px;border-bottom:1px solid var(--color-card-border, rgba(255,255,255,0.06))">'
                    ...
                    f'</div><div style="font-family:\'Cairo\',sans-serif;font-size:10px;color:var(--color-neutral-400, #a89f91);letter-spacing:0;font-weight:500;margin-top:2px">{role}</div></div></div>'
                    f'<div style="color:var(--color-neutral-400, #a89f91);cursor:pointer;padding:4px;display:flex;gap:3px"><span style="width:3px;height:3px;border-radius:50%;background:currentColor"></span><span style="width:3px;height:3px;border-radius:50%;background:currentColor"></span><span style="width:3px;height:3px;border-radius:50%;background:currentColor"></span></div></div>'
                ...
                ig_cards.append(
                    f'<article data-rv="1" class="ig-card" style="flex:none;width:clamp(310px,26vw,380px);border-radius:18px;overflow:hidden;display:flex;flex-direction:column;will-change:transform">'
                    f'<div style="display:flex;align-items:center;justify-content:space-between;padding:12px 14px;border-bottom:1px solid var(--color-card-border, rgba(255,255,255,0.06))">'
                    f'<div style="display:flex;align-items:center;gap:10px">'
                    f'<div style="width:38px;height:38px;border-radius:50%;padding:2px;background:linear-gradient(45deg, #f09433 0%, #e6683c 25%, #dc2743 50%, #cc2366 75%, #bc1888 100%);display:grid;place-items:center;flex-shrink:0">'
                    f'<div style="width:100%;height:100%;border-radius:50%;overflow:hidden;border:2px solid #1a1816;background:#2a2622">'
                    ...
                    f'<svg width="13" height="13" viewBox="0 0 24 24" fill="#3897f0" style="flex-shrink:0"><path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm-1 15l-5-5 1.41-1.41L11 14.17l7.59-7.59L20 8l-9 9z"/></svg>'
                    f'</div><div style="font-family:ui-monospace,SFMono-Regular,Menlo,monospace;font-size:10px;color:var(--color-neutral-400, #a89f91);letter-spacing:.02em">{role}</div></div></div>'
                    f'<div style="color:var(--color-neutral-400, #a89f91);cursor:pointer;padding:4px;display:flex;gap:3px"><span style="width:3px;height:3px;border-radius:50%;background:currentColor"></span><span style="width:3px;height:3px;border-radius:50%;background:currentColor"></span><span style="width:3px;height:3px;border-radius:50%;background:currentColor"></span></div></div>'
                    f'<div style="position:relative;aspect-ratio:4/3;background:#151413;overflow:hidden;cursor:pointer" ondblclick="handleIGCardDblClick(this)">'
                    f'<img data-media="1" src="{img}" alt="{handle} Showcase" draggable="false" style="width:100%;height:100%;object-fit:cover;display:block;transition:transform .7s cubic-bezier(.16,1,.3,1)">'
                    f'<div class="ig-heart-pulse" style="position:absolute;inset:0;display:grid;place-items:center;pointer-events:none;opacity:0;transform:scale(0.3);transition:all .35s cubic-bezier(.175,.885,.32,1.275)">'
